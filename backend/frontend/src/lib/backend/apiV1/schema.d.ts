...
export interface components {
    schemas: {
        ...
        RsDataChatBotChatRoomDto: {
            resultCode: string;
            msg: string;
            data: components["schemas"]["ChatBotChatRoomDto"];
        };
        PageDtoPostDto: {
            /** Format: int32 */
...
export interface operations {
    ...
    make: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ChatBotRoomMakeReqBody"];
            };
        };
        responses: {
            /** @description OK */
            200: {
                ...
                content: {
                    "application/json;charset=UTF-8": components["schemas"]["RsDataChatBotChatRoomDto"];
                };
            };
            /** @description Bad Request */
            400: {
